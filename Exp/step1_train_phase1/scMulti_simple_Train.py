...
import sys
sys.path.append("/home/ucbtsp5/Scratch/24Exp02_scLLM/G0-LM/src/") # repo folder into system path ##need change##
...
def train(task_name,code_loc,raw_data_loc,vocab_loc,
            model_ckpt,vocab_params, out_loc):
    ...
    obs_idx="QuiescenceStatus",  ##need change##
    ...
    label_key = "QuiescenceStatus", ##need change##
    ...
    #-----> project
    trainer_para.project = "DormancyLM" # project name  ##need change##
    trainer_para.entity= "shipan_work" # entity name  ##need change##
    ...
    #accuracy_val
    trainer_para.max_epochs = 5 # max epochs
    ...
    trainer_para.wandb_api_key = "ea7ad9bb7cc523fde48c45a0367ca16b33f9f138"  ##need change##
